            ...
            <Paper sx={{ m: '80px auto', elevalation: 10, borderRadius: '15px', width:'72%'}}>
                <Box sx={{ width: '100%', height: 480, backgroundColor: 'secondary.main', borderRadius: '15px' }}>
                    ...
                    <Box width='90%' borderBottom={1} borderColor='rgba(0, 0, 0, 0.38)' m='0 auto'>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%', m: '0 auto' }} >
                            <Typography fontSize={{ sm: '1rem' }} mt={1} mb={1} >Posts</Typography>
                            <Typography fontSize={{ sm: '1rem' }} mt={1} mb={1} >10</Typography>
                        </Box>
                    </Box>
                    <Box width='90%' borderBottom={1} borderColor='rgba(0, 0, 0, 0.38)' m='0 auto'>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%', m: '0 auto' }} >
                            <Typography fontSize={{ sm: '1rem' }} mt={2}  >Requests </Typography>
                            <Typography fontSize={{ sm: '1rem' }} mt={2}  >5</Typography>
                        </Box>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%', m: '0 auto' }} >
                            <Typography fontSize={{ sm: '1rem' }} mt={1} mb={1} >Upcoming</Typography>
                            <Typography fontSize={{ sm: '1rem' }} mt={1} mb={1} >1</Typography>
                        </Box>
                    </Box>
                    <Box width='90%' m='0 auto'>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%', m: '0 auto' }} >
                            <Typography fontSize={{ sm: '1rem' }} mt={2} >Dashboard</Typography>
                            {/* <Typography fontSize={{ sm: '1rem' }} mt={2} >5</Typography> */}
                        </Box>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%', m: '0 auto' }} >
                            <Typography fontSize={{ sm: '1rem' }} mt={1} >Manage Requests</Typography>
                            {/* <Typography fontSize={{ sm: '1rem' }} mt={1} >3</Typography> */}
                        </Box>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '80%', m: '0 auto' }} >
                            <Typography fontSize={{ sm: '1rem' }} mt={1} mb={1.5} >Report</Typography>
